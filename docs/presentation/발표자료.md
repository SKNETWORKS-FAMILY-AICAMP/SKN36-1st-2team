...
style: |
  ...
  section.cover .label { margin-bottom: 30px; }
  section.cover img { margin: 0 auto; display: block; }
  section.cover .rule { margin: 30px auto 26px; }
  section.cover h1 { font-size: 38px; margin-bottom: 10px; }
  section.cover p { margin-bottom: 0; }
  section.cover .team { margin-top: 34px; }
...
![w:520](images/fig00_logo_white.png)

<div class="rule"></div>

# 상권이 아니라 화물의 흐름을 봅니다

<p style="font-size:21px;color:#FFFFFF">화물차 등록 데이터 기반 물류 거점 분석 서비스</p>
